...
@Composable
fun Mariscos(navController: NavController, favoritosViewModel: FavoritosViewModel) {
    ...
    Scaffold(
            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navController.navigate("menu") }) {
                        Icon(
                            imageVector = Icons.Filled.ArrowBack, // Icono para volver al menú
                ...
                actions = {
                    Image(
                        painter = painterResource(id = R.drawable.sin_fondo), // Imagen pequeña en la barra superior
                ...
                colors = TopAppBarDefaults.smallTopAppBarColors(
                    ...
                    titleContentColor = Color.White, // Color blanco para el título
                    navigationIconContentColor = Color.White, // Color blanco para el icono de navegación
                    actionIconContentColor = Color.White // Color blanco para los iconos de acción
                )
            )
        },
        bottomBar = {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.mariscos),
                style = MaterialTheme.typography.labelLarge
            )
            // Lista de elementos mariscos usando LazyColumn
            LazyColumn {
                items(Datasource().mariscos()) { mariscos ->
                    // Tarjeta de lugar con información de mariscos
                    LugaresCard(
                        navController = navController,
                        lugar = mariscos,
                        isFavorite = favoritosViewModel.isFavorite(mariscos),
...
/**
 * Función de vista previa para la pantalla de Mariscos.
 */
@Preview(showBackground = true)
@Composable
fun MariscosPreview() {
    GastronomíaGPSTheme {
        Mariscos(navController = NavController(LocalContext.current), favoritosViewModel = FavoritosViewModel())
    }
}